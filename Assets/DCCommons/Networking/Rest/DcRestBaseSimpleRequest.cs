...
namespace DCCommons.Networking.Rest {
    public class DcRestBaseSimpleRequest : DCRestBaseRequest {
		...
		public DcRestBaseSimpleRequest(string path, HTTPMethods method) {
			this.path = path;
			this.method = method;
		}

		public DcRestBaseSimpleRequest AddQueryParam(string key, object value) {
			queryParams[key] = value;
			return this;
		}

		public DcRestBaseSimpleRequest AddHeader(string key, string value) {
			headers[key] = value;
			return this;
		}

		public DcRestBaseSimpleRequest AddBody(byte[] body) {
			this.body = body;
			return this;
		}

		public DcRestBaseSimpleRequest OnSuccess(RequestSuccessDelegate onSuccess) {
			this.onSuccess = onSuccess;
			return this;
		}
		
		public DcRestBaseSimpleRequest OnFail(RequestErrorDelegate onFail) {
			this.onFail = onFail;
			return this;
		}
	    
	    public DcRestBaseSimpleRequest OnComplete(RequestCompleteDelegate onComplete) {
